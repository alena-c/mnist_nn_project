...
def run_network():
    ...
    test_cost, test_accuracy, training_cost, training_accuracy             = net.SGD(training_data[:1000], 400, 10, 0.5, lmbda = 0.1,
...
def plots(test_cost, test_accuracy,  training_cost, training_accuracy):
    ...
    plt.legend(loc='best')
    plt.show()
    fig.savefig('Overfitting_results_1000 reg_01.png')
